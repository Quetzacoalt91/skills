...
- Run the update with `update:start` (TODO: Add param to know the command is run by an agent in analytics). This is a long process depending on the size of the store.
